...
export const HTTP_SERVICE_ENDPOINT =
  process.env.NODE_ENV !== 'development' ? 'https://frame-api-test.aside.fun' : 'http://localhost:3000'
export const WS_SERVICE_ENDPOINT =
  process.env.NODE_ENV !== 'development' ? 'wss://frame-api-test.aside.fun' : 'ws://localhost:3000'

export default () => {
  const axios = new Axios({
    baseURL: process.env.NODE_ENV !== 'development' ? 'https://frame-api-test.aside.fun' : '',
  })
